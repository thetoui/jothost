...
arrangement), 12 (the service manager) and 16 (the firewall): foundation,
authentication, Host Agent, dashboard, websites, subdomains, the nginx + Apache
engine, PHP, SSL, files, the code editor, databases, Node.js applications, host
services, and the packet filter.

Next is Phase 11 (logs). Phases are built in dependency order rather

...
func (d *Deps) Reset(t *testing.T) {
	...
	_, err := d.Pool.Exec(ctx, `
		TRUNCATE TABLE database_permissions, database_users, databases, ssl_certificates, php_pools, php_versions, audit_logs, two_factor_auth, session_token_history, sessions,

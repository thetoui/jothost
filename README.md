...
services, FTP accounts, DNS and the local name server, the packet filter, the
SSH server's settings, and fail2ban.

Next is Phase 21 (System Updates). Phases are built in dependency order rather

                ...
                >
                  <td className="px-2 py-2 align-middle">
                    <button
                      ...
                      aria-expanded={open}
                      aria-label={`${open ? 'Collapse' : 'Expand'} ${site.primary_domain}`}
                  ...
                  <td className="px-3 py-2">
                    <div className="flex items-center gap-2">
                      ...
                      <a
                        ...
                        aria-label={`Open ${site.primary_domain} in a new tab`}
                        className="shrink-0 text-slate-400 transition-colors hover:text-brand-700"
                      >
